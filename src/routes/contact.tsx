      ...
      <section className="bg-hero-gradient">
        <div className="mx-auto max-w-7xl px-6 py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
            Drop us a line or stop by — we usually reply within an hour.
          </p>
        </div>
      </section>
      <section className="mx-auto grid max-w-7xl gap-8 px-6 py-16 md:grid-cols-2">
        <div className="space-y-4">
          {[
            ...
            <Card
              key={c.title}
              className="flex items-center gap-4 rounded-2xl border-border/60 p-5 shadow-soft"
            >
          ...
          >
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <Input id="e" type="email" required maxLength={255} className="mt-1" />
              </div>
            </div>
            <div>
              <Label htmlFor="s">Subject</Label>
              <Input id="s" required maxLength={150} className="mt-1" />
            </div>
            <div>
              <Label htmlFor="m">Message</Label>
              <Textarea id="m" rows={5} required maxLength={1000} className="mt-1" />
            </div>
