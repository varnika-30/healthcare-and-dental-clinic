    ...
    <div className="grid min-h-screen md:grid-cols-2">
      <div className="hidden bg-primary-gradient md:flex md:flex-col md:justify-between md:p-12 md:text-primary-foreground">
        ...
        <div>
          ...
          <p className="mt-2 max-w-sm opacity-90">Book in seconds, see your records, get reminders.</p>
        </div>
        ...
        <Card className="w-full max-w-md rounded-2xl border-border/60 p-8 shadow-soft">
          ...
          >
            <div className="grid grid-cols-2 gap-3">
              <div><Label htmlFor="name">Full name</Label><Input id="name" name="name" required maxLength={100} className="mt-1" /></div>
              <div><Label htmlFor="phone">Phone</Label><Input id="phone" name="phone" maxLength={20} className="mt-1" /></div>
            </div>
            <div><Label htmlFor="email">Email</Label><Input id="email" name="email" type="email" required maxLength={255} className="mt-1" /></div>
            <div><Label htmlFor="password">Password</Label><Input id="password" name="password" type="password" required minLength={6} maxLength={72} className="mt-1" /></div>
            <div>
              <Label>I am a</Label>
              ...
              <p className="mt-1 text-xs text-muted-foreground">Staff accounts are reviewed by clinic admins.</p>
            </div>
