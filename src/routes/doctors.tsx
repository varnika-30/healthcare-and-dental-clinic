  ...
  head: () => ({
    meta: [
      { title: "Our Doctors — Lumident Dental" },
      {
        name: "description",
        content:
          "Meet our specialists — orthodontists, implantologists, cosmetic and pediatric dentists.",
      },
    ],
  }),
  component: Doctors,
...
const doctors = [
  ...
  },
  {
    ...
    spec: "Endodontist",
    avail: "Wed–Sat · 11am–7pm",
    years: 9,
    rating: 4.8,
  },
  {
    name: "Dr. Lina Chen",
    spec: "Pediatric Dentist",
    avail: "Mon–Fri · 8am–3pm",
    years: 7,
    rating: 4.9,
  },
  {
      ...
      <section className="bg-hero-gradient">
        <div className="mx-auto max-w-7xl px-6 py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
            Board-certified specialists, continuous training, and a shared belief: dentistry should
            feel calm.
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {doctors.map((d) => (
            <Card key={d.name} className="rounded-2xl border-border/60 p-6 shadow-soft">
              ...
              <BookAppointmentButton size="sm" className="mt-4 w-full bg-primary-gradient">
