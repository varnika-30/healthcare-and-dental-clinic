      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/auth/login">Patient portal</Link></li>
            <li><Link to="/auth/signup">Create account</Link></li>
          </ul>
        </div>
        <div>
          <p className="mb-3 font-display text-sm font-semibold">Visit us</p>
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex gap-2"><MapPin className="h-4 w-4 mt-0.5" />24 Bayview Ave, Suite 300</li>
            <li className="flex gap-2"><Phone className="h-4 w-4 mt-0.5" />(415) 555-0142</li>
            <li className="flex gap-2"><Mail className="h-4 w-4 mt-0.5" />hello@lumident.care</li>
          </ul>
        </div>
      </div>
